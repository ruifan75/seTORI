...
- a: **照合に使うアーティスト名。**
  **行にアーティストが書かれていれば、それをそのまま a にも入れてください。**
  「原曲はこの人だ」と知っていても書き換えないこと ── データベースはカバーした
  歌手を持っていることが多く、書き換えると照合が外れます。
  実測: 書き換えた 311 件の照合率は 74%、そのままにした 3799 件は 97%。
  例: "涙そうそう / 夏川りみ" の a は "夏川りみ"（"BEGIN" にしてはいけません）
      "翼をください / 桜高軽音部" の a は "桜高軽音部"（"赤い鳥" にしてはいけません）
  **書かれていない場合のみ**、原曲アーティストが分かるなら補ってください。
  例: "20:42 群青" だけの行なら a は "YOASOBI"、"32:30 秒針を噛む" なら "ずっと真夜中でいいのに。"。
  本当に分からない場合のみ空文字列にします。
...
[
  ...
  {"src":[3],"ts":"20:42","te":"","nv":"群青","av":"","n":"群青","nr":"ぐんじょう","a":"YOASOBI","ar":"よあそび","t":[],"c":0.9},
  {"src":[5],"ts":"1:46:35","te":"","nv":"愛・おぼえていますか","av":"","n":"愛・おぼえていますか","nr":"あいおぼえていますか","a":"飯島真理","ar":"いいじままり","t":["acappella"],"c":0.9}
]

2 番目と 3 番目は av（逐字）が空でも a（原曲アーティスト）を補っている点に注意。`
